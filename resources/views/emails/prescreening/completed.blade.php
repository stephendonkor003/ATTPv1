...
<head>
    ...
    <title>Prescreening Completed</title>
</head>
                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:0 0 16px 0;line-height:1.6;">
                                A prescreening evaluation has been completed and a detailed report is attached.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:12px 16px;">
                                        <div style="font-size:14px;line-height:1.6;">
                                            ...
                                            <strong>Submission Code:</strong> {{ $submission->procurement_submission_code ?? 'N/A' }}<br>
                                            <strong>Evaluator:</strong> {{ $submission->prescreeningResult?->evaluator?->name ?? 'N/A' }}<br>
                                            <strong>Status:</strong> {{ ucfirst(str_replace('_', ' ', $submission->status ?? 'pending')) }}
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:18px 0 0 0;line-height:1.6;">
                                The attached PDF is marked <strong>CONFIDENTIAL</strong> and should be handled securely.
                            </p>
                        </td>
                    </tr>
                    <tr>
